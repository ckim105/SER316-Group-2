...
public class WorkPanel extends JPanel {
	...
	void jbInit() throws Exception {
		...
		agendaB.setPreferredSize(new Dimension(100, 100));
		...
		eventsB.setPreferredSize(new Dimension(100, 100));
		...
		tasksB.setText(Local.getString("SCRUM BOARD"));
		...
		tasksB.setPreferredSize(new Dimension(100, 100));
		...
		filesB.setPreferredSize(new Dimension(100, 100));
