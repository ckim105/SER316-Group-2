...
public class TaskPanel extends JPanel {
    ...
    void jbInit() throws Exception {
        ...
        newTaskB.setIcon(
            new ImageIcon(main.java.memoranda.ui.AppFrame.class.getResource("/ui/icons/user-story-3397166-2826240.png")));
        ...
        subTaskB.setIcon(
            new ImageIcon(main.java.memoranda.ui.AppFrame.class.getResource("/ui/icons/s.task-icon.png")));
...
//        editTaskB.setEnabled(true);
        editTaskB.setIcon(
            new ImageIcon(main.java.memoranda.ui.AppFrame.class.getResource("/ui/icons/s.edit-task-icon.png")));
        ...
        removeTaskB.setIcon(
            new ImageIcon(main.java.memoranda.ui.AppFrame.class.getResource("/ui/icons/sn.remove-icon.png")));
        ...
        completeTaskB.setIcon(
            new ImageIcon(main.java.memoranda.ui.AppFrame.class.getResource("/ui/icons/sn.complete-icon.png")));
...
//			new ImageIcon(net.sf.memoranda.ui.AppFrame.class.getResource("/ui/icons/todo_remove.png")));
    ...
    ppEditTask.setIcon(new ImageIcon(main.java.memoranda.ui.AppFrame.class.getResource("/ui/icons/s.edit-task-icon.png")));
    ...
    ppRemoveTask.setIcon(new ImageIcon(main.java.memoranda.ui.AppFrame.class.getResource("/ui/icons/sn.remove-icon.png")));
    ...
    ppNewTask.setIcon(new ImageIcon(main.java.memoranda.ui.AppFrame.class.getResource("/ui/icons/user-story-3397166-2826240.png")));
    ...
    ppAddSubTask.setIcon(new ImageIcon(main.java.memoranda.ui.AppFrame.class.getResource("/ui/icons/s.task-icon.png")));
    ...
    */
	...
	ppCompleteTask.setIcon(new ImageIcon(main.java.memoranda.ui.AppFrame.class.getResource("/ui/icons/sn.complete-icon.png")));
	...
	ppCalcTask.setIcon(new ImageIcon(main.java.memoranda.ui.AppFrame.class.getResource("/ui/icons/sn.complete-icon.png")));
    ...
    void editTaskB_actionPerformed(ActionEvent e) {
        ...
        TaskDialog dlg = new TaskDialog(App.getFrame(), Local.getString("Edit Selected"));
...
//		CurrentProject.getTaskList().adjustParentTasks(t);
    ...
    void newTaskB_actionPerformed(ActionEvent e) {
        TaskDialog dlg = new TaskDialog(App.getFrame(), Local.getString("New User Story"));
    ...
    void removeTaskB_actionPerformed(ActionEvent e) {
        ...
        if (taskTable.getSelectedRows().length > 1)
			...
			if(CurrentProject.getTaskList().hasSubTasks(thisTaskId)) {
				msg = Local.getString("Removing the selected user story ")+"\n'" + t.getText() + Local.getString("' and all associated tasks.") +"\n"+Local.getString("Are you sure?");
			}
			else {
				msg = Local.getString("Removing the selected item ")+"\n'" + t.getText() + "'\n"+Local.getString("Are you sure?");
			}
        }
        int n =
            JOptionPane.showConfirmDialog(
                App.getFrame(),
                msg,
                Local.getString("Remove Selected"),
